...
let averageDailyAcres = totalAcres / pinkAcres.length
...
console.log(`fujiTons: ${fujiTons} galaTons: ${galaTons} pinkTons: ${pinkTons}`)
...
galaPounds *= 2000
pinkPounds *= 2000
console.log(`fujiPounds: ${fujiPounds}, galaPounds: ${galaPounds}, pinkPounds: ${pinkPounds}`)
// PROBLEM 6
...
console.log(`fujiProfit: ${fujiProfit}, galaProfit: ${galaProfit}, pinkProfit: ${pinkProfit}`)
